...
<div>
    ...
    <div class="containera">
        <img src="{{URL::asset('/images/detail.jpg')}}" class="img-fluid" width="100%" style="height: 350px;"
            alt="cover">
        <div class="img"></div>
        <div class="centered">
    ...
    <div class="container mt-5">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-4"><span
                            id="country"><?php echo str_replace(" ",",",$data['a']->cities) ?></span></div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide mt-4" data-ride="carousel">
                    <ol class="carousel-indicators">
                        ...
                        ?>
                        @for ($i = 0; $i < count($a); $i++) @if($i==0) <li data-target="#carouselExampleIndicators"
                    ...
                    <div class="carousel-inner">
                        @for ($i = 0; $i < count($a); $i++) @if($i==0) <div class="carousel-item active">
                            <img class="d-block w-100" height="450" src="data:image/png;base64, <?php echo $a[$i] ?>"
                                alt="slide">
        ...
        <div class="col-md-4">
            ...
            <button class="btn btn-primary btn-block"
                onClick="document.location.href='/userEvent/create/{{ $data['a']->id }}'">Book Now</button>
            @elseif(Auth::user()->role == 'Users')
            <button class="btn btn-primary btn-block"
                onClick="document.location.href='/userEvent/create/{{ $data['a']->id }}'">Book Now</button>
            @else
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <form action="/bid" method="POST" id="bid_value">
                                ...
                                <input type="hidden" value="{{ Auth::user()->block }}" id="block">
                                <input type="number" name="bid_price" id="bid_price" onkeypress="return noEnter()"
                                    class="form-control" style="background: #fff" required>
                            </form>
                        </div>
    ...
    function onSubmit() {
        ...
        if (!bidPrice) {
            ...
            if (!block) {
                ...
                swal("Blocked", "You can't bid","warning");
            }
